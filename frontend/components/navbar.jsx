          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-brown">
              ...
              <li>
                <a
                  href="#"
                  class="block py-2 pl-3 pr-4 text-cream rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-forest md:p-0 "
                >
                  About
                </a>
              </li>
              ...
              <li>
                <a
                  href="#"
                  class="block py-2 pl-3 pr-4 text-cream rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-forest md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                >
                  Pricing
                </a>
              </li>
